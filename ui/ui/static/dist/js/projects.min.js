...
<svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  `};(0,_e.default)(function(){(0,_e.default)("#jstree").jstree({sort:1,core:{data:{url:"/projects/json",dataType:"json"},themes:{name:"default"}},plugins:["checkbox","sort","types","wholerow"],sort:function(l,b){return this.get_type(l)===this.get_type(b)?this.get_text(l)>this.get_text(b)?1:-1:this.get_type(l)>=this.get_type(b)?1:-1}}),(0,_e.default)("#jstree").on("ready.jstree",function(l,b){return b.instance.open_node("#j1_1_anchor",!1,!0)}),(0,_e.default)("#jstree").on("select_node.jstree deselect_node.jstree",function(l){var b=[],ke=(0,_e.default)("#jstree").jstree("get_selected",!0);_e.default.each(ke,function(){var Ce=(0,_e.default)("#jstree").jstree();Ce.is_leaf(this)&&b.push(Ce.get_path(this,"/"))}),b.length>0?(0,_e.default)("#tree_data").val(JSON.stringify(b)):(0,_e.default)("#tree_data").removeAttr("value")}),btn=(0,_e.default)("#btn-toggle-job"),btn.hasClass("btn-pending")&&btn.one("click",function(){return _e.default.ajax({type:"PUT",url:window.location.href+"/toggle",dataType:"json"}).done(function(l){btn.removeClass("btn-"+l.old_status),btn.text(l.new_status.capitalize()),btn.addClass("btn-"+l.new_status)}).fail(function(l,b,ke){return console.log("error",l.status),console.log("STATUS: "+ke),!1}),!1}),previewButtons=(0,_e.default)(".btn-object-preview"),previewButtons.each(function(){(0,_e.default)(this).bind("click",function(){regex=/\d$/g;var l=(0,_e.default)(this).attr("id").match(regex);console.log(l),(0,_e.default)("body").prepend(_n(l)),(0,_e.default)("body").addClass("overflow-hidden"),(0,_e.default)(document).on("click","#preview-dialog-bg",function(){(0,_e.default)(this).remove(),(0,_e.default)("body").removeClass("overflow-hidden")}),(0,_e.default)(document).on("click","#preview-dialog-bg button",function(){(0,_e.default)(this).remove(),(0,_e.default)("body").removeClass("overflow-hidden")})}),(0,_e.default)(this).removeAttr("href"),(0,_e.default)(this).removeAttr("target")})});})();
/*!
